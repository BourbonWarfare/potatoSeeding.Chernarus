...
class grad_vehicleSpawner {
    class common {
        file = QUOTE(MODULES_DIRECTORY\grad-vehicleSpawner\functions\common);
    ...
    class dialog {
        file = QUOTE(MODULES_DIRECTORY\grad-vehicleSpawner\functions\dialog);
    ...
    class events {
        file = QUOTE(MODULES_DIRECTORY\grad-vehicleSpawner\functions\events);
    ...
    class spawn {
        file = QUOTE(MODULES_DIRECTORY\grad-vehicleSpawner\functions\spawn);
